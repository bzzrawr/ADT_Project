# Original Author: OMKAR PATHAK
# Second Author: SYAFIQ ALI OTHMAN
...
if __name__ == '__main__':
    ...
    end = time.time()   #stop measure time
    print(end - start)  #the execution time
    print(tree.find(4185)) #find value in tree
    print(tree.find(12))
